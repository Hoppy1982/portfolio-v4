  ...
  render() {
    return(
      <nav className={this.props.className}>
        ...
        <NavLink to='/projects' activeClassName='active' className='navbar__link'>Projects (int)</NavLink>
        <NavLink to='/sites' activeClassName='active' className='navbar__link'>Projects (ext)</NavLink>
      </nav>
    )
  }
}
